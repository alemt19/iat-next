  ...
  "emociones-colores-2": {
    ...
    blockInstructions: {
      "familarizacion-1": {
        ...
        leftCategory: "Nostalgia",
        rightCategory: "Tristeza",
        description: "Clasifica las emociones presionando el botón/tecla correspondiente para Nostalgia o Tristeza.",
        keyAssignment: { left: "e", right: "i" },
      },
      "familarizacion-2": {
        title: "Clasificación de Figuras",
      ...
      "asociacion-congruente-1": {
        ...
        rightCategory: "Tristeza o Cálido",
        description: "Presiona el botón/tecla correspondiente para Nostalgia o Frío, o Tristeza o Cálido.",
        keyAssignment: { left: "e", right: "i" },
      },
      "asociacion-congruente-2": {
        title: "Asociación Congruente - Parte 2",
        ...
        rightCategory: "Cálido o Tristeza",
        description: "Continúa clasificando. Presiona el botón/tecla correspondiente para Frío o Nostalgia, o Cálido o Tristeza.",
        keyAssignment: { left: "e", right: "i" },
      },
      "inversion": {
        title: "Clasificación de Emociones Invertida",
        leftCategory: "Tristeza",
        rightCategory: "Nostalgia",
        description: "Ahora clasifica las emociones invertidas presionando el botón/tecla correspondiente para Tristeza o Nostalgia.",
        keyAssignment: { left: "e", right: "i" },
      },
      "asociacion-incongruente-1": {
        title: "Asociación Incongruente - Parte 1",
        ...
        description: "Presiona el botón/tecla correspondiente para Tristeza o Frío, o Nostalgia o Cálido.",
        keyAssignment: { left: "e", right: "i" },
      },
      "asociacion-incongruente-2": {
        title: "Asociación Incongruente - Parte 2",
        ...
        description: "Continúa clasificando. Presiona el botón/tecla correspondiente para Frío o Tristeza, o Cálido o Nostalgia.",
        keyAssignment: { left: "e", right: "i" },
      },
    },
    blockCategorySides: {
