...
export const testConfigs: Record<string, TestConfig> = {
  ...
  "emociones-narrativa-2": {
    ...
    blockInstructions: {
      ...
      "asociacion-congruente-1": {
        title: "Asociación Congruente - Parte 1",
        leftCategory: "Nostalgia o Nacional",
        rightCategory: "Indiferencia o Extranjera",
        description: "Presiona el botón/tecla correspondiente para Nostalgia o Nacional, o Indiferencia o Extranjera.",
        keyAssignment: { left: "e", right: "i" },
      },
      "asociacion-congruente-2": {
        title: "Asociación Congruente - Parte 2",
        leftCategory: "Nacional o Nostalgia",
        rightCategory: "Extranjera o Indiferencia",
        description: "Continúa clasificando. Presiona el botón/tecla correspondiente para Nacional o Nostalgia, o Extranjera o Indiferencia.",
        keyAssignment: { left: "e", right: "i" },
      },
      "inversion": {
        title: "Clasificación de Emociones Invertida",
      ...
      "asociacion-incongruente-1": {
        title: "Asociación Incongruente - Parte 1",
        leftCategory: "Indiferencia o Nacional",
        rightCategory: "Nostalgia o Extranjera",
        description: "Presiona el botón/tecla correspondiente para Indiferencia o Nacional, o Nostalgia o Extranjera.",
        keyAssignment: { left: "e", right: "i" },
      },
      "asociacion-incongruente-2": {
        title: "Asociación Incongruente - Parte 2",
        leftCategory: "Nacional o Indiferencia",
        rightCategory: "Extranjera o Nostalgia",
        description: "Continúa clasificando. Presiona el botón/tecla correspondiente para Nacional o Indiferencia, o Extranjera o Nostalgia.",
        keyAssignment: { left: "e", right: "i" },
      },
    },
    blockCategorySides: {
